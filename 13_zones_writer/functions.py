def bus_name_lists():
    ...
    with open("lines_ckt24.dss") as lines_file:
    ...
    with open("buscoords_ckt24.dss") as coordinates_file:
...
def line_name_lists():
    ...
    with open("lines_ckt24.dss","r") as lines_file:
        lines_data = lines_file.readlines()
    ...
    # Add geographical coordinates to bus
    with open("buscoords_ckt24.dss","r") as coordinates_file:
        bus_coords = coordinates_file.readlines()
