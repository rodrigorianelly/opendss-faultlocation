...
def fault_LLL(faultbus,r,buscoords,l1,l2,l3,dssObj):
...
def main():
    ...
    # Define Fault after vbases, otherwise it bugs in this case
    ...
    fault_LLL(bus3p[0],r,[bus3p[1],bus3p[2]],l1,l2,l3,dssObj)

if __name__ == "__main__":

    print(
    """
This code plots a pu voltage profile for a LLL fault with a 5 ohms fault
resistance.
    """
    )
