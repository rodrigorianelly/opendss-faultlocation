...
def fault_LLG(faultbus,faultphases,phases,r,buscoords,l1,l2,l3,dssObj):
...
def main():
    ...
    fault_LLG(bus2p[0],faultphases,phases,r,[bus2p[1],bus2p[2]],
    l1,l2,l3,dssObj)
...
if __name__ == "__main__":
    ...
    print(
    """
This code plots a pu voltage profile for a LLG fault between phases B and C with
a 20 ohms fault resistance.
    """
    )
