...
def main():
    ...
    print(
    """
This code checks the maximum amount of photovoltaic generation of the same
value that can be installed on buses N292237, N312286, N292549, N292751 and
N284141 according to pu voltage variation in all buses, current in lines and
